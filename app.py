...
os.environ["GOOGLE_API_KEY"] = "Asd12edw"  # Replace with your actual key
...
def autonomous_agent(prompt: str):
    ...
    if model_decision.tool_calls:
        ...
        synthesis_prompt = ChatPromptTemplate.from_messages(
            [
                ("system", f"Synthesize a highly accurate response. Use the tool feedback to answer the user: {tool_feedback}"),
                ("user", "{input}"),
